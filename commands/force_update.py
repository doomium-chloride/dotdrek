...
from helpers import constants, message, updater

version_path = "./azurapi_data/version-info.json"

class ForceUpdate(BaseCommand):
    ...
    async def handle(self, params, message_obj, client):
        ...
        async with message_obj.channel.typing():
            await updater.update_azurapi(client, True)
